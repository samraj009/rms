...
if( ISSET($_POST['save_button']) ) {
   ...
   $result = rentcollection_row_insert($upload_file_name);
			...
			?>
			  ...
			  <div class="form-row">
				...
				<div class="form-group col-md-4">
				  ...
				  <input type="text" class="form-control" id="rent_amount" name="rent_amount" placeholder="" value="" readonly />
				</div>
			  ...
			  <div class="form-row">
				  ...
				  <div class="form-group col-md-4">
					  ...
					  <input type="text" class="form-control" id="rent_pay_month" name="rent_pay_month" placeholder="" value="" readonly />
				  </div>
