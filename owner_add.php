...
<body id="page-top">
  ...
  <div class="form-row">
	...
	<div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="owner_phone" name="owner_phone" placeholder="Enter Phone Number">
    </div>
	<div class="form-group col-md-4">
      <label for="owner_email">Owner Email</label>
      <input type="text" class="form-control" id="owner_email" name="owner_email" placeholder="Enter Email">
    </div>
  </div>
...
<div class="form-row"><h6 class="font-weight-bold text-primary" style="margin:15px 0;">Commision Details</h6></div>
  ...
  <div class="form-row">  
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="owner_commision" name="owner_commision" placeholder="Enter Commision">
    </div>
  </div>
  ...
  <div class="form-group col-md-4">
	...
	<textarea class="form-control" id="owner_address" name="owner_address" placeholder="Enter Address" rows="2"></textarea>
	</div>
  </div>
  <div class="form-row">
	...
	<div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="owner_district" name="owner_district">
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="owner_zipcode" name="owner_zipcode">
    </div>
  </div>
