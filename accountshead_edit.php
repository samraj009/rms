...
if( ISSET($_POST['save_button']) ) {
   ...
   $result = accounts_head_row_update();
   $msg = "Accounts Head updated";
	} else {
		$error_msg = "Please fill the fields";
	}	
} 

$params['account_id'] = $_GET['id'];
$result = accounts_head_row_select_single($params);
$row = ISSET($result[0]) ? $result[0] : array();
          ...
          <div class="card shadow mb-4">
			...
			?>
			  ...
			  <div class="form-row">
				  ...
				  <input type="text" class="form-control" id="account_name" name="account_name" placeholder="Enter Account Name" value="<?php echo ISSET($row['account_name']) ? $row['account_name']: '';?>" />
				</div>
			  </div>
			  ...
			  <div class="form-row">
				  ...
				  <input type="text" class="form-control" id="account_category" name="account_category" placeholder="" value="<?php echo ISSET($row['account_category']) ? $row['account_category']: '';?>" />
				</div>
			  </div>	
