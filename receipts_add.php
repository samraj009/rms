          ...
          <div class="card shadow mb-4">
			...
			?>
			  ...
			  <div class="form-group col-md-4">
				  <label for="date">Receipts Date <span class="required_field">&#8727;</span></label>
                ...
                <div class="form-row">
				  ...
				  <div class="form-group col-md-4">
				   ...
				   <div class="form-group col-md-4" style="display:none">
					  ...
					  <input type="text" class="form-control" id="quantity" name="quantity" placeholder="" value="1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
					</div>
